            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{route('homes.index')}}"><img src="{{asset('pages/images/home/logo.png')}}" alt="" /></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if(session('customerId') != null && session('shipping_id') == null)
                            <li><a href="{{route('checkout')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                            @elseif(session('customerId') != null && session('shipping_id') != null)
                            ...
                            @endif
                            <li><a href="{{route('carts.index')}}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a></li>
