                ...
                <table class="table table-condensed">
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img src="{{asset('uploads/product')}}/{{$content->options->images}}" alt="" width="100" height="100"></a>
                        </td>
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                                ...
                                <input type="submit" name="qtyUpdate" class="btn btn-default btn-sm" value="Cập nhật">
                                </form>
                            </div>
                        </td>
                        <td class="cart_total">
                        ...
                        <td class="cart_delete">
                            <a class="cart_quantity_delete" href="{{route('carts.destroy',$content->rowId)}}"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
...
{{--                </div>--}}
                <div class="col-sm-6">
                    <div class="total_area">
                        ...
                        @else
                            <a class="btn btn-default check_out" href="{{route('checkout.login')}}">Check Out</a>
                        @endif
                    </div>
                </div>
            </div>
